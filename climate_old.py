...
# - Uses climate.climate_schema(...) (replaces deprecated CLIMATE_SCHEMA)
# - Binds to esphome::climate::Climate via codegen namespace to avoid circular import
# - Converts to_code to async/await style
# - Keeps UART mapping logic and select support intact
...
# Bind to C++ classes via codegen namespaces to avoid circular import of Python modules
climate_ns = cg.esphome_ns.namespace("climate")
ClimateBase = climate_ns.class_("Climate")

MitsubishiHeatPump = cg.global_ns.class_("MitsubishiHeatPump", ClimateBase, cg.PollingComponent)

select_ns = cg.esphome_ns.namespace("select")
SelectBase = select_ns.class_("Select")
MitsubishiACSelect = cg.global_ns.class_("MitsubishiACSelect", SelectBase, cg.Component)
